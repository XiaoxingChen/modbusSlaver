...
#define CONSOLE_USE_UART3			1//change here
#define CONSOLE_IOGROUP_B10		1//change here
...
#elif 	CONSOLE_USE_UART3
	#define 	CONSOLE_TX_DMACH	DMA1_Channel2
#elif 	CONSOLE_USE_UART4
	#define 	CONSOLE_TX_DMACH	DMA2_Channel5
#endif
...
public:
	...
	int print_f(const char* fmt, ...) __attribute__((format(printf,2,3)));
...
#define postErr(msg) print_f("\r\nLocal-Err@canProbe: %s(%d)-%s(): %s\r\n", __FILE__, __LINE__, __FUNCTION__, msg)
#define printf(msg, args...) print_f("\r\nLocal@canProbe: "msg, ##args)
#endif
//end of file
